...
In the version 0.6, we use the resnet34 architecture. 
...
plt.xlabel("Epoch")
plt.ylabel("Accuracy")
plt.savefig("classifier_v6_accuracy_batch_{}_epoch_{}_CutMiX_semi_supervised_AdamW.png".format(batch_size, n_epochs))
plt.close()
...
torch.save(model_dict, "classifier_cnn_v6_batch_{}_epoch_{}_CutMiX_semi_supervised_AdamW.pth".format(batch_size, n_epochs))
print("Model saved.")
