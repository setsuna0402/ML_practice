...
The estimation of the value function is done by temporal difference method.
...
save_path = "lunar_lander_actor_critic_td_method"
# Define environment
...
agent = ActorCriticAgent(actor_network, value_network, gamma=0.99)
...
for batch in prg_bar:
    ...
    log_probs, rewards, states, next_states, dones = [], [], [], [], []  # 2D lists [i][j]: i-th episode, j-th step
    ...
    for episode in range(EPISODE_PER_BATCH):
        ...
        next_states.append([])  # next_states for this episode
        dones.append([])        # dones for this episode
        ...
        while True:
            ...
            next_states[episode].append(next_state)  # [s_2, s_3, ...., s_t+1]
            log_probs[episode].append(log_prob) # [log(a_1|s_1), log(a_2|s_2), ...., log(a_t|s_t)]
            dones[episode].append(done)  # [d_1, d_2, ...., d_t]
            ...
            if terminated or truncated:
                ...
                break
        '''
        # In TD, discounted rewards are considered in the learn func
        temp_list = []
        temp_reward = 0.0
    ...
    agent.learn_actor_critic_td(log_probs, rewards, states, next_states, dones)
    '''
    # For learn_trivial 
