...
n_epochs = 3000 # The number of training epochs for classifier. 
...
parser.add_argument("-O", "--output-dir", type=Path, default=Path("./trained_result_plots_v7_d"), help="Directory where checkpoints and plots are saved.")
