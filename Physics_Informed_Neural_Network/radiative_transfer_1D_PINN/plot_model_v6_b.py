#!/usr/bin/env python3
"""
Load a trained v6 PINN checkpoint and visualize conditioned predictions.
This version read the test paprameters from a text file and save the numerical and predicted intensity data to .npy files.
"""
...
from plot_model_linear import I_o_rand
...
def parse_args() -> argparse.Namespace:
	...
	parser.add_argument("-I", "--checkpoint", type=Path, default=None, help="Path to a .pth checkpoint..")
