...
def parse_args() -> argparse.Namespace:
	...
	parser.add_argument("-O", "--output-dir", type=Path, default=Path("trained_result_plots_v6_b"), help="Directory where plots are saved.")
...
def main() -> None:
	...
	'''
	'''
	I_o = torch.linspace(0.15, 1.0, n_sample).view(-1, 1)
	x_c = torch.linspace(0.05, 0.9, n_sample).view(-1, 1)
	freq = torch.linspace(0.09, 1.05, n_sample).view(-1, 1)
	'''
