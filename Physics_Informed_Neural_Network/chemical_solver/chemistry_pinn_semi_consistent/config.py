...
PRECOMPUTED_DATA_FILE = PROJECT_DIR / "grackle_relaxed_training_data_merged_10000.h5"
VALIDATION_DATA_FILE = PROJECT_DIR / "grackle_relaxed_validate_data.h5"  # Set to None to generate validation trajectories on the fly.
OUTPUT_DIR = PROJECT_DIR / "trained_results_v4_a"
...
HYDROGEN_FRACTION_BY_MASS = 0.76  # Must match Grackle chemistry_data.HydrogenFractionByMass
...
# -----------------------------------------------------------------------------
PRECOMPUTE_N_TRAJECTORIES = 100
PRECOMPUTE_SEED = 65438
# PRECOMPUTE_SEED = 13874358
# PRECOMPUTE_SEED = 1314520
...
# -----------------------------------------------------------------------------
# Frozen-coefficient PINN settings
# -----------------------------------------------------------------------------
PDE_ENABLED = True
PDE_LOSS_WEIGHT = 1.0e-4
PDE_WEIGHT_WARMUP_EPOCHS = 2500
PDE_START_EPOCH = 500
# Scale physical fraction-rate residuals to roughly O(1). Dataset Gamma values
# are stored in 1/Myr code-time units.
PDE_HI_RATE_REF = GAMMA_HI_REF
PDE_HEI_RATE_REF = GAMMA_HEI_REF
PDE_HEII_RATE_REF = GAMMA_HEII_REF
