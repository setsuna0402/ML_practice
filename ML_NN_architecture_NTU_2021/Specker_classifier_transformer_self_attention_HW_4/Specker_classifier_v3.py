...
In the version 0.3, we implent Self-attentive Pooling (SAP) to further improve the performance of the speaker classifier.
...
from Model_Class import Classifier_AMS_SAP, Classifier_AMS_SAP_MultiHead, Classifier_AMS, AMSoftmax
...
lambda_reg = 1.e-3 # hyperparameter for the loss of the self-attentive pooling. 
